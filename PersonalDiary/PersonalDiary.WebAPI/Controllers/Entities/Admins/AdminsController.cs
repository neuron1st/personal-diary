...
namespace PersonalDiary.WebAPI.Controllers.Entities.Admins;
...
public class AdminsController : ControllerBase
{
    ...
    public AdminsController(IAdminsManager adminsManager, IAdminsProvider adminsProvider, IMapper mapper, ILogger logger)
    {
